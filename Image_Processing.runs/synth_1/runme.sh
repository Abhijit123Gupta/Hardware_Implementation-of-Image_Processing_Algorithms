...
HD_PWD='G:/verilog_files/Image_Processing/Image_Processing.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log image_processing_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source image_processing_top.tcl
